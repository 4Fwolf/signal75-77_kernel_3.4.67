...
#define KXTJ9_DEV_NAME        "KXTE9"
/*----------------------------------------------------------------------------*/
static const struct i2c_device_id kxtj9_i2c_id[] = {{KXTJ9_DEV_NAME,0},{}};
static struct i2c_board_info __initdata i2c_kxtj9={ I2C_BOARD_INFO("KXTE9", (KXTJ9_WR_SLAVE_ADDR >> 1))};
...
//static int kxtj9_i2c_detect(struct i2c_client *client, struct i2c_board_info *info);

static int kxtj9_local_init(void);
static int kxtj9_remove(void);

static int kxtj9_init_flag =0; // 0<==>OK -1 <==> fail
...
static int kxtj9_i2c_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	if(data != 0x07)
	{
		GSE_ERR("KXTJ9 Read ID error, line: %d\n", __LINE__);
		kxtj9_init_flag = -1;
		return -1;
	}
...
{
	GSE_FUN();
        i2c_register_board_info(0, &i2c_kxtj9, 1);
